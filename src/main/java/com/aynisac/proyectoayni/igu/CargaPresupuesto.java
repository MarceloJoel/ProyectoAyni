...
public class CargaPresupuesto extends javax.swing.JFrame {

    Controladora control = new Controladora();

    public CargaPresupuesto() {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.guardarPresupuesto(nombreEmp, tiempo, condicion, precio, observacion);
