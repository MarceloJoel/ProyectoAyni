...
public class ModifViabilidadPedido extends javax.swing.JFrame {
    ...
    public ModifViabilidadPedido(int idCliente) {
    ...
    private void initComponents() {
        ...
        cmbVisTec = new javax.swing.JComboBox<>();
        ...
        jLabel6.setText("Visita Técnica:");
        ...
        cmbVisTec.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "SI", "NO" }));

        cmbDetalle.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "SI", "NO" }));

        cmbPlano.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "SI", "NO" }));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(44, 44, 44)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cmbVisTec, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JComboBox<String> cmbVisTec;
    ...
    private void cargaDatos(int idCliente) {
        //Buscamos en la BD
        ...
        if (cliente.getPlano().equals("SI")) {
            cmbPlano.setSelectedIndex(1);
        } else if (cliente.getPlano().equals("NO")) {
            cmbPlano.setSelectedIndex(2);
        }
        
        if (cliente.getDetalle().equals("SI")) {
            cmbDetalle.setSelectedIndex(1);
        } else if (cliente.getDetalle().equals("NO")) {
            cmbDetalle.setSelectedIndex(2);
        }
        
        if (cliente.getVisTec().equals("SI")) {
            cmbVisTec.setSelectedIndex(1);
        } else if (cliente.getVisTec().equals("NO")) {
            cmbVisTec.setSelectedIndex(2);
        }
